  ...
  return {
    ...
    values: {
      ...
      Precision: !data
        ? '-'
        : percentRoundString(
            getPrecision(data.true_positives, data.false_positives),
          ),
      Recall: !data
        ? '-'
        : getRecall(data.true_positives, data.false_negatives),
  ...
  return {
    ...
    values: {
      ...
      Precision: !data
        ? '-'
        : percentRoundString(
            getPrecision(data['truePositives'], data['falsePositives']),
          ),
      Recall: !data
        ? '-'
        : percentRoundString(
            getRecall(data['truePositives'], data['falseNegatives']),
          ),
