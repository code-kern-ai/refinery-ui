...
export function postProcessZeroShot(heuristic: Heuristic, labelingTasks: LabelingTask[], attributes: Attribute[]) {
...
function fillZeroShotSettings(settingsJson: string, labelingTasks: LabelingTask[], labelingTaskId: string, attributes: Attribute[]) {
