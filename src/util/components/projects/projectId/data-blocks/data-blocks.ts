...
export function postProcessCurrentDataBlockColumn(dataColumn: DataBlockColumn): DataBlockColumn {
    ...
    if (dataColumn.sourceCode == null) {
        prepareDataColumn.sourceCode = AttributeCodeLookup.getAttributeCalculationTemplate(AttributeCalculationExamples.AC_EMPTY_TEMPLATE, prepareDataColumn.dataType).code;
