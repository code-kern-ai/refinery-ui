import {
  ChartData,
  LabelDistribution,
} from '@/src/types/components/projects/projectId/project-overview/charts'
...
export function changeDataStructure(
  ...
  chartData.values = [valuesScaleProgrammatically, valuesScaleManually]
  return chartData
}
...
export function parseOverviewSettingsToDict(
  interAnnotatorFormGroup: any,
