...
export enum ModalEnum {
    ...
    VIEW_RECORD_DETAILS_DATA_BLOCK_COLUMN = "VIEW_RECORD_DETAILS_DATA_BLOCK_COLUMN",
    ...
    VIEW_EVALUATION_SET = "VIEW_EVALUATION_SET",
    DELETE_EVALUATION_SET = "DELETE_EVALUATION_SET",
    EVALUATION_GROUP = "EVALUATION_GROUP",
    DELETE_EVALUATION_GROUP = "DELETE_EVALUATION_GROUP",
    VIEW_EVALUATION_GROUP = "VIEW_EVALUATION_GROUP",
    EVALUATION_RUN = "EVALUATION_RUN",
    EVALUATION_META_FILTER_APPLY = "EVALUATION_META_FILTER_APPLY",
    EVALUATION_REFORMULATE = "EVALUATION_REFORMULATE",
    DELETE_EVALUATION_RUN = "DELETE_EVALUATION_RUN",
    DELETE_DATA_BLOCK = "DELETE_DATA_BLOCK",
    CREATE_DATA_BLOCK = "CREATE_DATA_BLOCK",
    CREATE_DATA_BLOCK_COLUMN = "CREATE_DATA_BLOCK_COLUMN",
}