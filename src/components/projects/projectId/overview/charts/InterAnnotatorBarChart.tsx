...
export default function InterAnnotatorBarChart(props: BarChartProps) {
  useEffect(() => {
        ...
        if (elementData.userIdA != elementData.userIdB) {
          ...
          divTooltip.html(
            '<span style="font-family: \'DM Sans\', sans-serif;">' +
              userLookup[elementData.userIdA].name +
              ' / ' +
              userLookup[elementData.userIdB].name +
              '</span>',
          )
        }
      }
    ...
    svg
      ...
      .attr('x', function (e) {
        return x(userLookup[e.userIdA].id)
      })
      .attr('y', function (e) {
        return y(userLookup[e.userIdB].id)
      })
  ...
  return (
    <>
      <div
        className={`${style.annotatorMatrixTooltip} annotatorMatrixTooltip`}
      ></div>
