    ...
    return (<Modal modalName={ModalEnum.LABELING_SETTINGS} doNotFullyInit={true}>
        <div className="flex flex-row items-center justify-center gap-x-2">
            ...
            <Tooltip content={<MultilineTooltip tooltipLines={['Note that your browser stores these settings.', 'Not your user or your organization!']} />} color="invert" placement="top" className="cursor-auto">
                <MemoIconInfoCircle className="h-6 w-6" />
            </Tooltip>
        </div>
        ...
        {activeTab == ComponentType.MAIN && <div className="flex flex-col gap-y-2 items-center my-4">
            <div className="grid gap-y-2 gap-x-4 items-center text-left" style={{ gridTemplateColumns: 'max-content auto max-content' }}>
                ...
                <Tooltip content={TOOLTIPS_DICT.LABELING.AUTO_NEXT_RECORD} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                <span>Hover background</span>
                <KernDropdown options={hoverColorOptions} buttonName={settings?.main.hoverGroupBackgroundColor} backgroundColors={hoverColorClassArray}
                ...
                <Tooltip content={TOOLTIPS_DICT.LABELING.HOVER_BACKGROUND} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                ...
                <Tooltip content={TOOLTIPS_DICT.LABELING.LINE_BREAKS} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                {settings?.main.lineBreaks != LineBreaksType.NORMAL && <Fragment>
                    ...
                    <Tooltip content={TOOLTIPS_DICT.LABELING.PRE_WRAP} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                    ...
                    <input type="radio" checked={settings?.main.lineBreaks == LineBreaksType.IS_PRE_LINE} onChange={toggleLineBreaksPreWrap} name="lineBreaks" id="preLine"
                        className="focus:ring-blue-500 h-6 w-4 text-blue-600 border-gray-200 cursor-pointer" />
                    <Tooltip content={TOOLTIPS_DICT.LABELING.PRE_LINE} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                </Fragment>}
            </div>
        </div>}
        {/* Task Header */}
        {activeTab == ComponentType.TASK_HEADER && <div className="flex flex-col gap-y-2 items-center my-4">
            ...
            <div className="grid gap-y-2 gap-x-4 items-center text-left" style={{ gridTemplateColumns: 'max-content auto max-content' }}>
                ...
                <Tooltip content={<MultilineTooltip tooltipLines={['Completely hide/show the feature.', 'Active settings are preserved']} />} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                <span>Collapse</span>
                <span className="cursor-pointer flex items-center">
                ...
                <Tooltip content={TOOLTIPS_DICT.LABELING.IS_COLLAPSED} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                ...
                <Tooltip content={TOOLTIPS_DICT.LABELING.QUICK_BUTTON} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
            </div>
        </div>}
        {/* Labeling */}
        {activeTab == ComponentType.LABELING && <div className="flex flex-col gap-y-2 items-center my-4">
            <div className="grid gap-y-2 gap-x-4 items-center text-left" style={{ gridTemplateColumns: 'max-content auto max-content' }}>
                ...
                <Tooltip content={<MultilineTooltip tooltipLines={['Amount of label buttons shown before hiding the rest under: \'other \<task\> options\'']} />} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                ...
                <Tooltip content={TOOLTIPS_DICT.LABELING.CLOSE_LABEL_BOX} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                ...
                <Tooltip content={TOOLTIPS_DICT.LABELING.SHOW_TASK_NAMES} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                ...
                <Tooltip content={<MultilineTooltip tooltipLines={['Display the heuristic label confidence.', 'Please see in our docs for more information on confidence calculation.']} />} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                ...
                <Tooltip content={TOOLTIPS_DICT.LABELING.LABEL_DISPLAY} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                ...
                <Tooltip content={<MultilineTooltip tooltipLines={['Groups display of labels in type, task, creator & label. Same group gets the same distance to the text.', 'Might use a lot of space.']} />} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
            </div>
        </div>}
        {/* Overview table */}
        {activeTab == ComponentType.OVERVIEW_TABLE && <div className="flex flex-col gap-y-2 items-center my-4">
            <div className="grid gap-y-2 gap-x-4 items-center text-left" style={{ gridTemplateColumns: 'max-content auto max-content' }}>
                ...
                <Tooltip content={TOOLTIPS_DICT.LABELING.SHOW_HEURISTICS} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
                ...
                <Tooltip content={<MultilineTooltip tooltipLines={['If active the table will filter entries depending on task legend settings.', 'Note that show heuristic disabled will overrule this']} />} color="invert" placement="top" className="cursor-auto"><MemoIconInfoCircle className="h-5 w-5" /></Tooltip>
            </div>
        </div>}
    </Modal >)
}