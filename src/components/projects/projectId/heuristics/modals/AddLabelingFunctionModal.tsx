...
export default function AddLabelingFunctionModal() {
  ...
  const [acceptButtonLF, setAcceptButtonLF] =
  ...
  return (
    <Modal
      modalName={ModalEnum.ADD_LABELING_FUNCTION}
      acceptButton={acceptButtonLF}
    >
      <h1 className="mb-4 text-center text-lg text-gray-900">
        Add new labeling function
      </h1>
      <div
      ...
      >
        ...
        <Tooltip
          content={TOOLTIPS_DICT.HEURISTICS.ENTER_FUNCTION_NAME}
          color="invert"
          placement="right"
        >
          <div className="justify-self-start">
            <span className="card-title label-text mb-0 cursor-help text-left">
              <span className="filtersUnderline underline">Function name</span>
            </span>
          </div>
        </Tooltip>
        <input
