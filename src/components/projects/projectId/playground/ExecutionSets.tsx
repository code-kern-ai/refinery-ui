    ...
    return <>
        {projectId != null && <div className="p-4 bg-gray-100 h-full flex-1 flex flex-col overflow-y-auto">
            <div className="text-lg leading-6 text-gray-900 font-medium w-full flex items-center">
                <div>
                    <label>Execution sets</label>
                    <div className="mt-1">
                        <div className="text-sm leading-5 font-normal text-gray-500 inline-block">You can create your execution sets and use them for creating execution groups.</div>
                    </div>
                </div>
                <button
                    ...
                    onClick={() => dispatch(openModal(ModalEnum.EXECUTION_SET))}>Create execution</button>
            </div >
