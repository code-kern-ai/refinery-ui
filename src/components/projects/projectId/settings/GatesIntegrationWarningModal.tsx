...
export default function GatesIntegrationWarningModal() {
  ...
  return (
    <Modal
      modalName={ModalEnum.GATES_INTEGRATION_WARNING}
      acceptButton={acceptButton}
    >
      <h1 className="mb-2 text-lg text-gray-900">Confirmation</h1>
      <div className="my-2 text-sm text-gray-500">
        Are you sure you want to run the gates integration?
        <p>
          Recreation of the embeddings will calculate them one more time and
          could cause additional fees.
        </p>
      </div>
    </Modal>
  )
