...
export default function DataSchema(props: DataSchemaProps) {
  ...
  function updatePrimaryKey(attribute: Attribute) {
    ...
    updateAttributeMut({
      variables: {
        projectId: projectId,
        attributeId: attributeNew.id,
        isPrimaryKey: attributeNew.isPrimaryKey,
      },
    }).then(() => {
    ...
    <div>
      ...
      <div className="mt-1">
        <div className="inline-block text-sm font-medium leading-5 text-gray-700">
          This schema holds the data structure of your project. It contains the
          attributes uploaded on project creation and the added calculated
          attributes.
        </div>
                ...
                <tr>
                  ...
                  >
                    <div className="flex flex-row flex-nowrap items-center justify-center leading-3">
                      ...
                      <div className="inline-block h-3.5 w-4">
                        {props.pKeyValid != null && (
                          <>
                            {props.pKeyValid ? (
                              <Tooltip
                                content={
                                  TOOLTIPS_DICT.PROJECT_SETTINGS.DATA_SCHEMA
                                    .UNIQUE_COMBINATION
                                }
                                color="invert"
                                placement="bottom"
                              ...
                              >
                                <IconCheck className="-mt-1 h-5 w-5" />
                              </Tooltip>
                            ) : (
                              <Tooltip
                                content={
                                  TOOLTIPS_DICT.PROJECT_SETTINGS.DATA_SCHEMA
                                    .NOT_UNIQUE_COMBINATION
                                }
                                color="invert"
                                placement="bottom"
                                className="cursor-auto"
                              >
                                <IconX className="-mt-1 h-5 w-5" />
                              </Tooltip>
                            )}
                          </>
                        )}
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap px-3 py-2 text-center text-sm text-gray-500">
                        <label className="cursor-pointer">
                          <input
                            ...
                            onChange={() => updatePrimaryKey(attribute)}
                          />
                        </label>
                      </td>
                      <td className="whitespace-nowrap px-3 py-2 text-center text-sm text-gray-500">
                      ...
                      <td className="px-3 py-2 text-center text-sm text-gray-500">
                        <Dropdown2
                          buttonName={
                            ATTRIBUTES_VISIBILITY_STATES[
                              attribute.visibilityIndex
                            ].name
                          }
                          options={ATTRIBUTES_VISIBILITY_STATES}
                          dropdownWidth="w-52"
                          selectedOption={(option: any) =>
                            updateVisibility(option, attribute)
                          }
                        ...
                        {attribute.userCreated ? (
                          <button
                            ...
                            onClick={() => {
                              ...
                              router.push(
                                `/projects/${projectId}/attributes/${attribute.id}`,
                              )
                            }}
                          >
