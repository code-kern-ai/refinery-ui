...
export default function DeleteModelCallBacksModal(
  props: DeleteModelCallBacksModalProps,
) {
  ...
  return (
    <Modal
      modalName={ModalEnum.DELETE_MODEL_CALLBACKS}
    ...
    >
      ...
      <div className="my-2 flex flex-col text-sm text-gray-500">
        <span>
          ...
          {props.countSelected <= 1 ? 'callback' : 'callbacks'}?
        </span>
        <span>
