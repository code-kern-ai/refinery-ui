...
export default function DeleteLookupListsModal(
  props: DeleteLookupListsModalProps,
) {
  ...
  return (
    <Modal modalName={ModalEnum.DELETE_LOOKUP_LIST} abortButton={abortButton}>
      ...
      <div className="my-2 flex flex-col text-sm text-gray-500">
        <span>
          Are you sure you want to delete selected lookup{' '}
          {props.countSelected <= 1 ? 'list' : 'lists'}?
        </span>
        <span>
