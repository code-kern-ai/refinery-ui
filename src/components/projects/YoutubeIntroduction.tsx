...
const YOUTUBE_URL =
  'https://www.youtube.com/embed/Hwlu6GWzDH8?autoplay=1&enablejsapi=1'
...
export default function YoutubeIntroduction() {
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden ${style.imageVideo}`}
    >
      {saveUrl ? (
        <iframe
          width="560"
        ...
        <div>
          ...
          >
            <svg
              ...
              className="h-20 w-20 cursor-pointer text-indigo-500"
              fill="currentColor"
              viewBox="0 0 84 84"
            >
