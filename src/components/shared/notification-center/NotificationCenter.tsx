    ...
    return (<div className="h-full w-full flex-1 flex flex-col overflow-y-auto" style={{ maxHeight: 'calc(100vh - 180px)' }}>
        <div className="h-full flex flex-col p-2">
            {notifications && notifications.length > 0 && notifications.map((notification, index) => (<div key={index}>
                {notification.array[0].level === NotificationLevel.WARNING && <div className={`mb-2 rounded-md border border-yellow-300 bg-yellow-50 p-3 ${style.outlineFade} ${notification.highlightMe ? style.outlineKern : ''}`}>
                    <div className="flex">
                ...
                {notification.array[0].level === NotificationLevel.SUCCESS && <div className={`mb-2 rounded-md border border-green-300 bg-green-50 p-3 ${style.outlineFade} ${notification.highlightMe ? style.outlineKern : ''}`}>
                    <div className="flex">
                        <div className="flex-shrink-0">
                ...
                {notification.array[0].level === NotificationLevel.INFO && <div className={`mb-2 rounded-md border border-blue-300 bg-blue-50 p-3 ${style.outlineFade} ${notification.highlightMe ? style.outlineKern : ''}`}>
                    <div className="flex">
                        <div className="flex-shrink-0">
                ...
                {notification.array[0].level === NotificationLevel.ERROR && <div className={`mb-2 rounded-md border border-red-300 bg-red-50 p-3 ${style.outlineFade} ${notification.highlightMe ? style.outlineKern : ''}`}>
                    <div className="flex">
                        <div className="flex-shrink-0">
