  ...
  const deleteElement = useCallback(() => {
    ...
    switch (props.elementType) {
      case DangerZoneEnum.ATTRIBUTE:
        deleteAttributeMut({
          variables: { projectId: projectId, attributeId: props.id },
        }).then(() => {
          setIsDeleting(false)
      ...
      case DangerZoneEnum.LOOKUP_LIST:
        deleteLookupListMut({
          variables: { projectId: projectId, knowledgeBaseId: props.id },
        }).then(() => {
          setIsDeleting(false)
      ...
      case DangerZoneEnum.CROWD_LABELER:
        deleteHeuristicMut({
          variables: { projectId: projectId, informationSourceId: props.id },
        }).then(() => {
          setIsDeleting(false)
        })
  ...
  return (
    <Modal modalName={ModalEnum.DELETE_ELEMENT} abortButton={abortButton}>
      ...
      <div className="my-2 text-sm text-gray-500">
        ...
        <p>
          This will delete all data associated with it, including labeling
          tasks.
        </p>
