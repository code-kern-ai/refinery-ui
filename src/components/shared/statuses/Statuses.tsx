...
function StatusBadge({ color, statusName }) {
    return <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${color === 'green' ? 'bg-green-300' : 'bg-' + color + '-100'} ${color === 'green' ? '' : 'text-' + color + '-800'} `}>
