...
function LoadingIcon(props: LoadingIconProps) {
  ...
  return (
    <div role="status">
      <svg
        aria-hidden="true"
        className={`${props.removeMargin ? 'mx-0' : 'mx-2'} animate-spin rounded-full ${colorClasses} ${sizeClasses} cursor-default border-0`}
        viewBox="0 0 100 101"
        fill="none"
