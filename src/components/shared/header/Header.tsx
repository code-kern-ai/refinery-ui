        ...
        <header className="sticky top-0 z-50 w-full">
            <div className="relative z-10 flex-shrink-0 h-16 bg-white border-b border-gray-200 shadow-sm flex justify-between items-center">
                ...
                <div className="flex items-center">
                    ...
                    {!(currentPage == CurrentPage.PROJECTS || currentPage == CurrentPage.USERS || currentPage == CurrentPage.NEW_PROJECT || currentPage == CurrentPage.MODELS_DOWNLOAD) && <div className="ml-6 text-gray-700 text-sm font-normal">
