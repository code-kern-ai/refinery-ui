...
export default function LogoutDropdown() {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        {user && (
          <Menu.Button className="mr-4 flex items-center rounded-full bg-gray-100 text-gray-400 hover:text-gray-600 focus:outline-none">
            <img
        ...
        <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <Menu.Item>
              {({ active }) => (
                <a
                  onClick={() => window.open('/auth/settings', '_blank')}
