...
export const { setModalStates, openModal, closeModal, initModal } =
  modalSlice.actions
export const modalReducer = modalSlice.reducer

//selectors
export const selectModals = (state) => state.modals
export const selectModalsValues = createSelector([selectModals], (a): any =>
  a ? Object.values(a) : null,
)
export const selectAllOpenModals = createSelector(
  [selectModalsValues],
  (a): any => (a ? a.filter((o) => o.open) : null),
)
